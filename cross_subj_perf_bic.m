function cross_subj_perf(roi_glmodel, roi_contrast, glmodel, standardize, clusterFWEcorrect, extent, odd_runs, contra)
...
filename = sprintf('cross_subj_perf_bic_roiglm%d_%s_glm%d_%s_standardize=%d_corr=%d_extent=%d_contra=%d.mat', roi_glmodel, replace(roi_contrast, ' ', '_'), glmodel, what, standardize, clusterFWEcorrect, extent, contra);
disp(filename);
