...
sbatch_output=`sbatch -p ncf --mem 50001 -t 1-1:20 -o ${outfileprefix}_%j.out -e ${outfileprefix}_%j.err --wrap="matlab -nodisplay -nosplash -nojvm -r $'main_effect(21, \'RU\', \'dlpfc\');exit'"`
sbatch_output_split=($sbatch_output)
job_id=${sbatch_output_split[3]}
echo main_effect.sh GLM 21, RU, dlpfc: ${outfileprefix}_${job_id}.out -- $sbatch_output >> jobs.txt
...
sbatch_output=`sbatch -p ncf --mem 50001 -t 1-1:20 -o ${outfileprefix}_%j.out -e ${outfileprefix}_%j.err --wrap="matlab -nodisplay -nosplash -nojvm -r $'main_effect(21, \'TU\', \'dlpfc\');exit'"`
sbatch_output_split=($sbatch_output)
job_id=${sbatch_output_split[3]}
echo main_effect.sh GLM 21, TU, dlpfc: ${outfileprefix}_${job_id}.out -- $sbatch_output >> jobs.txt
