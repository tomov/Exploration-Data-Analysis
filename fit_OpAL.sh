...
# send the job to NCF
#
sbatch_output=`sbatch -p ncf --mem 50000 -t 20-15:20 -o ${outfileprefix}_%j.out -e ${outfileprefix}_%j.err --wrap="matlab -nodisplay -nosplash -nojvm -r $'fit_OpAL(load_data, 25, \'params_OpAL_25nstarts_mixed.mat\', 1, 0);exit'"`
sbatch_output_split=($sbatch_output)
job_id=${sbatch_output_split[3]}
