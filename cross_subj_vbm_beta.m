function cross_subj_vbm(glmodel, regressor, contrast, standardize)
...
filename = sprintf('cross_subj_vbm_beta_glm%d_%s_%s_%s_standardize=%d.mat', glmodel, regressor, replace(contrast, ' ', '_'), what, standardize);
disp(filename);
